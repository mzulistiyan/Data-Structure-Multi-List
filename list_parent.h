...
address_relasi findRelasi(List_relasi &LR, List_parent &LP, List_child &LC, string px, string cx);
void disconnect(List_relasi &LR, List_parent &LP, List_child &LC, string px, string cx);
